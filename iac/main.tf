...
resource "azurerm_linux_function_app" "function_app" {
  ...
  app_settings = {
    ...
    ENABLE_ORYX_BUILD        = 1 # See this thread : https://stackoverflow.com/questions/72280118/deployment-failed-with-error-package-deployment-using-zip-deploy-failed-refer/75415822#75415822
  }
